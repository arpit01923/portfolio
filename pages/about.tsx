...
import Scroll from "@/components/standard/scroll";
...
const About = () => {
    return (
        <section className="grid gap-10">
            ...
            <div className="grid gap-5">
                <div className="max-w-[600px] mx-auto">
                    <p className="text-2xl font-bold">
                        MERN Stack Developer <span className="text-primary">@E Software Solutions</span>
                    </p>
                    <p className="font-thin">2022-Present | Haryana, India</p>
                    <p>
                        Collaborate with the design and backend teams to develop responsive and intuitive user
                        interfaces for web applications. Implement frontend solutions, leveraging React.js to enhance
                        website performance and user engagement.
                    </p>
                </div>
                <div className="max-w-[600px] mx-auto">
                    <p className="text-2xl font-bold">
                        Intern <span className="text-primary">@Emulus Consulting</span>
                    </p>
                    <p className="font-thin">Summer 2022 | Gurugram, India</p>
                    <p>
                        I am actively engaged in crafting innovative and efficient web applications. With a strong focus
                        on code quality and best practices, I continuously strive to enhance the performance and
                        scalability of React.js projects at Emulus Consulting.
                    </p>
                </div>
            </div>
            ...
            <div className="grid gap-5">
                <div className="max-w-[600px] mx-auto">
                    <p className="text-2xl font-bold"> Bachelor of Technology In Computer Science</p>
                    <p className="font-thin">2018-2022 | Kurukshetra University, Kurukshetra, India</p>
                    <p>
                        A Bachelor of Technology in Computer Science equips individuals with a comprehensive
                        understanding of computer systems and software development, enabling them to tackle complex
                        technological challenges and drive innovation in the digital era.
                    </p>
                </div>
                <div className="max-w-[600px] mx-auto">
                    ...
                    <p>
                        Completing my education in the CBSE Board&apos;s 10+2 system, I gained a comprehensive
                        understanding of diverse subjects, fostering a well-rounded academic foundation.
                    </p>
                </div>
            </div>
        </section>
