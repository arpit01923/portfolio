        ...
        <main className="grid p-5 place-items-center lg:grid-cols-2 gap-10">
            ...
            <div className="grid gap-5">
                ...
                <p className="text-lg text-center md:text-left">
                    Welcome to my portfolio as a frontend developer! With a passion for creating immersive user
                    experiences, I specialize in crafting elegant and responsive websites. From pixel-perfect designs to
                    seamless interactions, my goal is to bring your vision to life while delivering exceptional
                    functionality and aesthetics. Explore my projects and discover the artistry of frontend development.
                </p>
